...
1. télécharger la release V1.1 du plugin contenant Galette 7.8 sur le gist https://github.com/trinitrotoluene76/galette_subs_git
...
5. remplacer entièrement la base de données Galette par bdd_test_sql.sql avec phpmyadmin
		détails de la bdd:
